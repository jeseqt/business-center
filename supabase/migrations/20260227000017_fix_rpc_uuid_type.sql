...
-- Migration ID: 20260227000017_fix_rpc_uuid_type
-- Description: Fixes type mismatch in get_or_create_user_dashboard_data.
--              The column platform_users.external_user_id is UUID, not TEXT.
...
BEGIN
    ...
    -- external_user_id is UUID, so direct comparison works
    ...
    IF v_platform_user_id IS NULL THEN
        ...
        -- Note: external_user_id expects UUID
