-- Migration ID: 20260227000006_fix_dashboard_rpc_uuid
-- Description: Fixes type mismatch in get_or_create_user_dashboard_data (external_user_id is UUID, not TEXT)
...
DECLARE
    v_user_id uuid;
    v_external_user_id uuid; -- Changed to UUID to match table column
    v_app_id uuid;
